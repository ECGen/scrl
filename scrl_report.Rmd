...
- Both SEMs fit the data showing neither the lichen ($df$ = , $Chi^2$
  = , $p-value$ = ) nor the plant ($df$ = , $Chi^2$ = , $p-value$ = )
  models showing significant differences from their observed
  covariance matrices based on $\Chi^2$ Goodness of Fit tests.
- Ultimately, moth induced changes to crown size explained
  significant amounts of community variation in differences in lichen
  abundance, richness and diversity, as well as significant variation
  in plant community differences in abundance ($R^2$ = ), richness
  ($R^2$ = ) and diversity ($R^2$ = ). Whole community differences
  between moth susceptible and resistant trees were also signifcantly
  explained by crown size differences for both lichens ($R^2$ = ) and
  plants ($R^2$ = ).
