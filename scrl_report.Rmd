...
altered tree traits. The SEMs fit the lichen ($df$ = `r
sem.fm.tab.rot.all["Lichens", 2]`, $X^2$ = `r
sem.fm.tab.rot.all["Lichens", 1]`, $p$-value = `r
sem.fm.tab.rot.all["Lichens", 3]`) data well, as the model did not
...
variation in differences in lichen abundance ($R^2$ = `r
r2.l.rot.all["l.A"]`), richness ($R^2$ = `r r2.l.rot.all["l.R"]`) and
diversity ($R^2$ = `r r2.l.rot.all["l.D"]`). Whole community
...
model fit ($df$ = `r sem.fm.tab.rot.all["Plants", 2]`, $X^2$ = `r
sem.fm.tab.rot.all["Plants", 1]`, $p$-value = `r
sem.fm.tab.rot.all["Plants", 3]`); however, only the effect of tree
crown on litter was significant and neither light nor litter showed
significant effects on any of the plant community metrics (see Figure
5).
