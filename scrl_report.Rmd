...
- Ultimately, moth induced changes explained significant amounts of
  community variation in differences in lichen abundance ($R^2$ = `r
  r2.l.rot.all["l.A"]`), richness ($R^2$ = `r r2.l.rot.all["l.R"]`)
  and diversity ($R^2$ = `r r2.l.rot.all["l.D"]`), as well as in plant
  community differences in abundance ($R^2$ = `r
  r2.v.rot.all["p.A"]`), richness ($R^2$ = `r r2.v.rot.all["p.A"]`)
  ...
  ($R^2$ = `r r2.l.rot.all["l.X1"]`) and plants ($R^2$ = `r
  r2.v.rot.all["p.D"]`).
