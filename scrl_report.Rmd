...
altered tree traits. The SEM fit the lichen ($df$ = `r sem.fm.tab.rot.all["Lichens", 2]`, $X^2$ = `r sem.fm.tab.rot.all["Lichens", 1]`, $p$-value = `r sem.fm.tab.rot.all["Lichens", 3]`) data well, as the model did not
...
variation in differences in lichen abundance ($R^2$ = `r r2.l.rot.all["l.A"]`), richness ($R^2$ = `r r2.l.rot.all["l.R"]`) and
diversity ($R^2$ = `r r2.l.rot.all["l.D"]`). Whole community differences between moth susceptible and resistant trees were also
signifcantly explained by crown size differences for lichens ($R^2$ =
`r r2.l.rot.all["rot.l.X1"]`). These effects were significantly
...
model fit ($df$ = `r sem.fm.tab.rot.norock["Plants", 2]`, $X^2$ = `r sem.fm.tab.rot.norock["Plants", 1]`, $p$-value = `r sem.fm.tab.rot.norock["Plants", 3]`); however, only the effect of tree
