...
set.seed(12345)
fit.l.rot.arc <- lavaan::sem(lav.l.rot.arc, data = apply(sem.dat, 2, std))
set.seed(12345)
fit.v.rot.arc <- lavaan::sem(lav.v.rot.arc, data = apply(sem.dat, 2, std))
...
summary(fit.l.rot.arc, rsquare = TRUE)
summary(fit.v.rot.arc, rsquare = TRUE)
