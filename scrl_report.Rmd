...
altered tree traits. The SEMs fit the lichen ($df$ = `r sem.fm.tab.rot.all["Lichens", 2]`, $X^2$ = `r
sem.fm.tab.rot.all["Lichens", 1]`, $p$-value = `r sem.fm.tab.rot.all["Lichens", 3]`) data well, as the model did not
