...
```{r deps, echo = TRUE, results = "hide", eval = TRUE, cache = FALSE}
...
```{r data-load-lich, results = "hide", cache = FALSE}
...
```{r table-ard, results = "asis", cache = FALSE}

kable(ard.tab, digits = 3)

```

```{r table-ttests-arh, results = "asis", cache = FALSE}
...
```{r plot-envcor-heatmap, cache = FALSE}
...
```{r table-perm-env-lich, cache = FALSE}
...
```{r plot-litter-rockbig, cache = FALSE}
...
```{r data-veg-check, echo = FALSE, cache = FALSE}
...
```{r data-veg-check-treeid, echo = FALSE, cache = FALSE}
...
```{r veg-table-comstats, cache = FALSE}
...
```{r table-veg-ard, results = "asis", cache = FALSE}
...
```{r veg-rel-moth-permtab, echo = FALSE, cache = FALSE}
...
```{r veg-env-seq-permtab, echo = FALSE, cache = FALSE}
...
```{r veg-rel-env-seq-permtab, echo = FALSE, cache = FALSE}
...
```{r isp-veg, echo = FALSE, cache = FALSE}
...
```{r isp-veg-table, echo = FALSE, cache = FALSE}
...
```{r org-data, eval = TRUE, echo = FALSE, results = "hide", cache = FALSE}
...
```{r moth-com, results = "asis", cache = FALSE}
...
```{r moth-ard, results = "asis", cache = FALSE}
...
```{r moth-env, results = "asis", cache = FALSE}
...
l.com.dif.vec.rot <- envfit(l.com.dif.ord.proc, env.dif)
v.com.dif.vec.rot <- envfit(v.com.dif.ord.proc, env.dif)

```


```{r sem-data, cache = FALSE}
...
```{r plot-sem-tidy-lichen-rot, cache = FALSE}
...
graph_sem(fit.l.rot.all, layout = lay)

```

```{r plot-sem-tidy-plant-rot, cache = FALSE}
...
graph_sem(fit.v.rot.all, layout = lay)
