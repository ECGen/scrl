...
xtable::xtable(modindices(fit.v.rot.norock))
...
sem.norocks <- rbind(
    table_results(fit.v.rot.norocks)[, c("label", "est_sig", "se", "pval")])
sem.norocks <- sem.norocks[!(duplicated(sem.norocks[, 1])), ]
sem.norocks[,1] <- gsub("rot.", "", sem.norocks[, 1])
sem.norocks[,1] <- gsub(".A.", ".abundance.", sem.norocks[, 1])
sem.norocks[,1] <- gsub(".R.", ".richness.", sem.norocks[, 1])
sem.norocks[,1] <- gsub(".D.", ".diversity.", sem.norocks[, 1])
sem.norocks[,1] <- gsub(".X", ".axis", sem.norocks[, 1])
...
write.csv(file = "results/sem_results_norocks.csv",
          sem.norocks,
          row.names = FALSE)
