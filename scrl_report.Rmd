...
l.com.dif.ord.proc <- procrustes(env.dif[, "rocks.big"], l.com.dif.ord)$Yrot
v.com.dif.ord.proc <- procrustes(env.dif[, "rocks.small"], v.com.dif.ord)$Yrot
...
lav.l.rot.all <- 'litter ~ crown
              rocks.big ~ litter
              l.A ~ light + rocks.big
              l.R ~ light + rocks.big
              l.D ~ light + rocks.big
              rot.l.X1 ~ light + rocks.big
              rot.l.X2 ~ light + rocks.big
              l.A ~~ l.R
              l.A ~~ l.D
              l.R ~~ l.D
              l.A ~~ rot.l.X1
...
lav.v.rot.all <- 'litter ~ crown
              ...
              p.R ~ rocks.small  + litter
              p.D ~ rocks.small
              rot.p.X1 ~ light + rocks.small
              rot.p.X2 ~ light + rocks.small
              rot.p.X3 ~ light + rocks.small
              p.A ~~ rot.p.X2
              p.A ~~ p.R
              p.A ~~ p.D
              p.R ~~ p.D
